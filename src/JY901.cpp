...
void CJY901::GetTime()
{
	readRegisters(ucDevAddr, JY901_YYMM, 8, (char*)&stcTime);	
}
void CJY901::GetAcc()
{
	readRegisters(ucDevAddr, JY901_AX, 6, (char *)&stcAcc);
}
void CJY901::GetGyro()
{
	readRegisters(ucDevAddr, JY901_GX_REG, 6, (char *)&stcGyro);
}
 
void CJY901::GetAngle()
{
	readRegisters(ucDevAddr, JY901_ROLL, 6, (char *)&stcAngle);
}
void CJY901::GetMag()
{
	readRegisters(ucDevAddr, JY901_HX, 6, (char *)&stcMag);
}
void CJY901::GetPress()
{
	readRegisters(ucDevAddr, JY901_PRESSUREL, 8, (char *)&stcPress);
}
void CJY901::GetDStatus()
{
	readRegisters(ucDevAddr, JY901_D0STATUS, 8, (char *)&stcDStatus);
}
void CJY901::GetLonLat()
{
	readRegisters(ucDevAddr, JY901_LONL, 8, (char *)&stcLonLat);
}
void CJY901::GetGPSV()
{
	readRegisters(ucDevAddr, JY901_GPSHEIGHT, 8, (char *)&stcGPSV);
}
CJY901 JY901 = CJY901();